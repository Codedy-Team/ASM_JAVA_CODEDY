    ...
    <div class="table-wrapper" style="margin-top: 15px">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="admin/product/create" class="btn btn-success"><i
        ...
        <div class="">
            <div class="modal-header">
                <button class="back" style="vertical-align: middle"
                        onclick="window.location.href='admin/product'; return false;">
                ...
                <div style="display: inline-block; float: right">
                    <a href="admin/product/edit/?id=${product.id}" class="edit" style="margin-right: 10px">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>image:</label>
                    <br>
                    <img style="height: 120px;" src="assets/dashboard/data-images/products/${product.image}"
                         alt="product.image">
                    <p>${ product.image }</p>
                </div>
