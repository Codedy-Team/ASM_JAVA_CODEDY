            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="custom-checkbox">
                                <input type="checkbox" id="checkbox1" name="productIds[]" value="1">
                                <label for="checkbox1"></label>
                            </span>
                        </td>
                        <td>01</td>
                        <td>
                            <img style="height: 75px;" src="assets/data-images/products/capuchino.jpg"
                                alt="product.image">
                        </td>
                        <td>Cappuccino</td>
                        <td>Coffee, milk, cream</td>
                        <td>$12.68</td>
                        <td>
                            <a href="show.html" class="view">
