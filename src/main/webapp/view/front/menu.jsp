                    ...
                    <c:forEach var="product" items="${PRODUCT_LIST}">
                        <div class="col-xl-6 col-md-6 col-lg-6">
                            <div class="single_delicious d-flex align-items-center">
                                <div class="thumb">
                                    <img src="assets/dashboard/data-images/products/${product.image}" alt="" height="166" width="166">
                                </div>
                                <div class="info">
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-lg-6">
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/1.png" alt="">
                            </div>
                            <div class="info">
                        ...
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/3.png" alt="">
                            </div>
                            <div class="info">
                                <h3>#10. Fried Rice</h3>
                                <p>Craft beer elit seitan exercitation photo booth et 8-bit kale chips.</p>
                        ...
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/5.png" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6">
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/2.png" alt="">
                            </div>
                            <div class="info">
                        ...
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/4.png" alt="">
                            </div>
                            <div class="info">
                        ...
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="assets/front/img/delicious/6.png" alt="">
                            </div>
                            <div class="info">
                ...
                <div class="testmonial_active owl-carousel">
                    <div class="single_carousel">
                        <div class="single_testmonial ">
                            ...
                            <div class="testmonial_author">
                                <div class="thumb">
                                    <img src="assets/front/img/testimonial/author.png" alt="">
                                </div>
                                <div class="name">
                    ...
                    <div class="single_carousel">
                        <div class="single_testmonial ">
                            ...
                            <div class="testmonial_author">
                                <div class="thumb">
                                    <img src="assets/front/img/testimonial/author2.png" alt="">
                                </div>
                                <div class="name">
...
<div class="Reservation_area">
    <div class="rev_icon_1 d-none d-md-block">
        <img src="assets/front/img/icon/4.png" alt="">
    </div>
    <div class="rev_icon_2 d-none d-md-block">
        <img src="assets/front/img/icon/5.png" alt="">
    </div>
    <div class="rev_icon_3 d-none d-md-block">
        <img src="assets/front/img/icon/6.png" alt="">
    </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6">
                            <div class="single_add d-flex">
                                <div class="icon">
                                    <img src="assets/front/img/svg_icon/address.svg" alt="">
                                </div>
                                <div class="ifno">
                                    <h4>Address</h4>
                        ...
                        <div class="col-lg-6">
                            <div class="single_add d-flex">
                                <div class="icon">
                                    <img src="assets/front/img/svg_icon/head.svg" alt="">
                                </div>
                                <div class="ifno">
                                    <h4>Reservation</h4>
                                    <p>+10 673 567 367</p>
                ...
                <div class="col-xl-3 col-md-6 col-lg-3 ">
                    <div class="footer_widget">
                        <div class="footer_logo">
                            <a href="#">
                                <img src="assets/front/img/footer_logo.png" alt="">
                            </a>
                        </div>
