...
public class RestaurantDatabaseService {
    ...
    public RestaurantDatabaseService(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    public List<Restaurant> all() throws Exception {
        ...
        try {
            ...
            String sql = "select * from restaurant WHERE deleted = false order by id desc ";
            ...
            while (resultSet.next()) {
                // get new item object
                Restaurant tempItem = getRestaurentFormResultSet(resultSet);
    ...
    public Restaurant find(int id) throws Exception {
        ...
        try {
            ...
            String sql = "select * from restaurant where deleted = false and id = ?";
            ...
            if (resultSet.next()) {
                item = getRestaurentFormResultSet(resultSet);
            } else {
    ...
    private Restaurant getRestaurentFormResultSet(ResultSet resultSet) throws SQLException {
